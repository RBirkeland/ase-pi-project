...
<%
    ...
    // view of the Greetings belonging to the selected Guestbook.
     ...
     int i = greetings.size();    
     if(i > 5){
     	for(int it = greetings.size(); it > 5; it--){
 			ObjectifyService.ofy().delete().entity(greetings.get(it-1));    		
     	}
     }
...
<%
      // Look at all of our greetings
        for (Greeting greeting : greetings) {
            ...
            // give greeting_id
            Long greeting_id = greeting.id;
            pageContext.setAttribute("greeting_id", greeting_id);
            String author;
...
<blockquote>${fn:escapeXml(greeting_id)}</blockquote>
<%
        }
    }
%>
